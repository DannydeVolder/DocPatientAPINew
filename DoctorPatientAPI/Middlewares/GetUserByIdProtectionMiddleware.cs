...
{
    public class GetUserByIdProtectionMiddleware
    {

        private readonly RequestDelegate _next;

        public GetUserByIdProtectionMiddleware(RequestDelegate next)
        {
            _next = next;
        }
        ...
        {
            if (!context.Request.Path.StartsWithSegments("/api/patients/getbyid"))
            {
